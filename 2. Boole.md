...
## 3. Les conditions
On se rend compte à partir des précédents exemples que notre quotidien est fonction de conditions. Conditions pour se lever (Est-il l'heure de se lever ?), Mettre son pantalon (Est-il relevé assez haut ?), Faire son café (Avant d'appuyer sur le bouton, ai-je mis une tasse en-dessous ?), etc.
